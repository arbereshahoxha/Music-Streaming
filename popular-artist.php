...
<body>
    ...
    <main>
        <div class="container">
            <div class="artist">
                <img src="Artists/Eminem.jpg" class="images">
                <div class="description">
                    ...
                    <a href="https://www.biography.com/musicians/eminem"><input type="button" value="Read More" id="info"></a>
                </div>
            </div>
            <div class="artist">
                ...
                <div class="description">
                    ...
                    <a href="https://www.biography.com/musicians/akon">
                        <input type="button" value="Read More" id="info">
                    </a>
                </div>
            </div>
            <div class="artist">
                ...
                <div class="description">
                    ...
                    <a href="https://en.wikipedia.org/wiki/Elai_(rapper)"><input type="button" value="Read More" id="info"></a>
                </div>
            </div>
            <div class="artist">
                ...
                <div class="description">
                    ...
                    <a href="https://www.britannica.com/biography/Dua-Lipa"><input type="button" value="Read More" id="info"></a>
                </div>
            </div>
            <div class="artist">
                ...
                <div class="description">
                    ...
                    <a href="https://www.britannica.com/biography/Billie-Eilish"><input type="button" value="Read More" id="info"></a>
                </div>
            </div>
            <div class="artist">
                ...
                <div class="description">
                    ...
                    <a href="https://www.britannica.com/biography/Taylor-Swift"><input type="button" value="Read More" id="info"></a>
                </div>
            </div>
            <div class="artist">
                ...
                <div class="description">
                    ...
                    <a href="https://www.britannica.com/topic/Queen-British-rock-group"><input type="button" value="Read More" id="info"></a>
                </div>
            </div>
            <div class="artist">
                ...
                <div class="description">
                    ...
                    <a href="https://www.britannica.com/biography/Rihanna"><input type="button" value="Read More" id="info"></a>
                </div>
            </div>
            <div class="artist">
                ...
                <div class="description">
                    ...
                    <a href="https://www.britannica.com/biography/Lady-Gaga"><input type="button" value="Read More" id="info"></a>
                </div>
            </div>
            <div class="artist">
                ...
                <div class="description">
                    ...
                    <a href="https://www.britannica.com/biography/Adele"><input type="button" value="Read More" id="info"></a>
                </div>
            </div>
            <div class="artist">
                ...
                <div class="description">
                    ...
                    <a href="https://www.britannica.com/biography/Beyonce"><input type="button" value="Read More" id="info"></a>
                </div>
            </div>
            <div class="artist">
                ...
                <div class="description">
                    ...
                    <a href="https://www.biography.com/musicians/shawn-mendes"><input type="button" value="Read More" id="info"></a>
                </div>
            </div>
            <div class="artist">
                ...
                <div class="description">
                    ...
                    <a href="https://en.wikipedia.org/wiki/Camila_Cabello"><input type="button" value="Read More" id="info"></a>
                </div>
            </div>
            <div class="artist">
                ...
                <div class="description">
                    ...
                    <a href="https://www.britannica.com/biography/Drake"><input type="button" value="Read More" id="info"></a>
                </div>
            </div>
            <div class="artist">
                ...
                <div class="description">
                    ...
                    <a href="https://en.wikipedia.org/wiki/Dhurata_Dora"><input type="button" value="Read More" id="info"></a>
                </div>
            </div>
            <div class="artist">
                ...
                <div class="description">
                    ...
                    <a href="https://en.wikipedia.org/wiki/Elvana_Gjata"><input type="button" value="Read More" id="info"></a>
                </div>
            </div>
            <div class="artist">
                ...
                <div class="description">
                    ...
                    <a href="https://en.wikipedia.org/wiki/Noizy"><input type="button" value="Read More" id="info"></a>
                </div>
            </div>
            <div class="artist">
                ...
                <div class="description">
                    ...
                    <a href="https://en.wikipedia.org/wiki/Yll_Limani"><input type="button" value="Read More" id="info"></a>
                </div>
            </div>
            <div class="artist">
                ...
                <div class="description">
                    ...
                    <a href=""><input type="button" value="Read More" id="info"></a>
                </div>
            </div>
            <div class="artist">
                ...
                <div class="description">
                    ...
                    <a href="https://www.teksteshqip.com/teuta-selimi/biografia"><input type="button" value="Read More" id="info"></a>
                </div>
            </div>
            <div class="artist">
                ...
                <div class="description">
                    ...
                    <a href="https://www.teksteshqip.com/shyhrete-behluli/biografia"><input type="button" value="Read More" id="info"></a>
                </div>
            </div>
            <div class="artist">
                ...
                <div class="description">
                    ...
                    <a href="https://en.wikipedia.org/wiki/Buta_(rapper)"><input type="button" value="Read More" id="info"></a>
                </div>
            </div>
            <div class="artist">
                ...
                <div class="description">
                    ...
                    <a href="https://en.wikipedia.org/wiki/MC_Kresha"><input type="button" value="Read More" id="info"></a>
                </div>
            </div>
            <div class="artist">
                ...
                <div class="description">
                    ...
                    <a href="https://en.wikipedia.org/wiki/Elita_5"><input type="button" value="Read More" id="info"></a>
                </div>
            </div>
        </div>
    </main>
